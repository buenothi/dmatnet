...
public class CadastroEmpresaMB implements Serializable {
	...
	@EJB
	private PessoaJuridicaServiceLocal pessoaJuridicaFachada;

	@EJB
	private EmpresaGrupoServiceLocal empresaGrupoFachada;
	...
	public EmpresaGrupoServiceLocal getEmpresaGrupoFachada() {
		return empresaGrupoFachada;
	}

	public void setEmpresaGrupoFachada(EmpresaGrupoServiceLocal empresaGrupoFachada) {
